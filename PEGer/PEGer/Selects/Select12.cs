...
namespace PEGer
{
    public class Select<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult> : ExpressionBase<TResult>
    {
        ...
        Func<ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, Exception> error;
        ...
        {
            return obj is Select<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, TResult> select &&
                   ...
                   EqualityComparer<Func<ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, Exception>>.Default.Equals(this.error, select.error);
        }

        public override int GetHashCode()
        {
            var hashCode = 645503119;
            ...
            hashCode = hashCode * -1521134295 + EqualityComparer<Func<ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, Exception>>.Default.GetHashCode(this.error);
            return hashCode;
        }
        ...
        internal override InstanceBase<TResult, ParseResult> InstanceImplement<ParseResult>(Parser<ParseResult> parser, List<IExpression> exprs, int thisIndex)
        {
            ...
            {
                error = (excs) => this.error(excs[0], excs[1], excs[2], excs[3], excs[4], excs[5], excs[6], excs[7], excs[8], excs[9], excs[10], excs[11]);
            }
    ...
    public class EqualSelect12<T> : Select<T, T, T, T, T, T, T, T, T, T, T, T, T>
    {
        public EqualSelect12(ExpressionBase<T> expr1, ExpressionBase<T> expr2, ExpressionBase<T> expr3, ExpressionBase<T> expr4, ExpressionBase<T> expr5, ExpressionBase<T> expr6, ExpressionBase<T> expr7, ExpressionBase<T> expr8, ExpressionBase<T> expr9, ExpressionBase<T> expr10, ExpressionBase<T> expr11, ExpressionBase<T> expr12, Func<T, T> func1, Func<T, T> func2, Func<T, T> func3, Func<T, T> func4, Func<T, T> func5, Func<T, T> func6, Func<T, T> func7, Func<T, T> func8, Func<T, T> func9, Func<T, T> func10, Func<T, T> func11, Func<T, T> func12, Func<ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, Exception> error) : base(expr1, expr2, expr3, expr4, expr5, expr6, expr7, expr8, expr9, expr10, expr11, expr12, func1, func2, func3, func4, func5, func6, func7, func8, func9, func10, func11, func12, error)
        {

        }

        public Select<T, T, T, T, T, T, T, T, T, T, T, T, TResult> Change<TResult>(Func<T, TResult> func1, Func<T, TResult> func2, Func<T, TResult> func3, Func<T, TResult> func4, Func<T, TResult> func5, Func<T, TResult> func6, Func<T, TResult> func7, Func<T, TResult> func8, Func<T, TResult> func9, Func<T, TResult> func10, Func<T, TResult> func11, Func<T, TResult> func12, Func<ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, Exception> error)
        {
            return Select<TResult>.Create(this.expr1, this.expr2, this.expr3, this.expr4, this.expr5, this.expr6, this.expr7, this.expr8, this.expr9, this.expr10, this.expr11, this.expr12, func1, func2, func3, func4, func5, func6, func7, func8, func9, func10, func11, func12, error);
        }
        public Select<T, T, T, T, T, T, T, T, T, T, T, T, TResult> Change<TResult>(Func<T, TResult> func1, Func<T, TResult> func2, Func<T, TResult> func3, Func<T, TResult> func4, Func<T, TResult> func5, Func<T, TResult> func6, Func<T, TResult> func7, Func<T, TResult> func8, Func<T, TResult> func9, Func<T, TResult> func10, Func<T, TResult> func11, Func<T, TResult> func12)
        {
            return Select<TResult>.Create(this.expr1, this.expr2, this.expr3, this.expr4, this.expr5, this.expr6, this.expr7, this.expr8, this.expr9, this.expr10, this.expr11, this.expr12, func1, func2, func3, func4, func5, func6, func7, func8, func9, func10, func11, func12);
        }
        public Select<T, T, T, T, T, T, T, T, T, T, T, T, T> Change(Func<ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, ParsingException, Exception> error)
        {
            return Select<T>.Create(this.expr1, this.expr2, this.expr3, this.expr4, this.expr5, this.expr6, this.expr7, this.expr8, this.expr9, this.expr10, this.expr11, this.expr12, error);
        }
        public static EqualSelect13<T> operator |(EqualSelect12<T> lhs, ExpressionBase<T> rhs)
        {
            return new EqualSelect13<T>(lhs.expr1, lhs.expr2, lhs.expr3, lhs.expr4, lhs.expr5, lhs.expr6, lhs.expr7, lhs.expr8, lhs.expr9, lhs.expr10, lhs.expr11, lhs.expr12, rhs, Echo, Echo, Echo, Echo, Echo, Echo, Echo, Echo, Echo, Echo, Echo, Echo, Echo, null);
        }
    }
}
